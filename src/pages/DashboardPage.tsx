...
// Removed unused imports for RatingViewer and TraineeScheduleManagement
...
const DashboardPage: React.FC = () => {
  ...
  const currentBasePath = location.pathname.split('/')[2]; 
  ...
  return (
    <div className="flex flex-col md:flex-row min-h-[calc(100vh-150px)]">
      ...
      <div className="flex-1 p-6 bg-gray-900 shadow-lg md:ms-4"> 
        <Routes>
